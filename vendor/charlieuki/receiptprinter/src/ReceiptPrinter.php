...
class ReceiptPrinter
{
    ...
    public function addItem($name, $customer, $qty, $price, $unit, $payment) {
        $item = new Item($name, $customer, $qty, $price, $unit, $payment );
        $item->setCurrency($this->currency);
        // $formatted_value = $this->currency . number_format($price, 0, ',', ',');
