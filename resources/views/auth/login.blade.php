                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            <a href="index.html" class="brand-logo">
                                ...
                                <h2 class="brand-text text-primary ms-1">{{ __('Login') }}</h2>
                            </a>

                            <h4 class="card-title mb-1 text-center">Welcome to BHAKOR PMS! 👋</h4>
                            ...
                            <form class="auth-login-form mt-2" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="email"  id="lemail" name="email"  aria-describedby="login-email" tabindex="1"
                                ...
                                <div class="mb-1">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"  tabindex="3"
